                    ...
                    <form class="space-y-4" action="{{ route('game.store') }}" method="POST">
                        ...
                        <div>
                            ...
                            <label for="period_number" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                {{ __('messages.periodLength') }}
                            </label>
                            <select name="period_number" id="period_number" required class="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-gray-200">
                                <option class="block text-sm font-medium text-gray-700 dark:text-gray-300" value="" disabled hidden selected>{{ __('messages.choosePeriodLength') }}</option>
                                @for ( $i = 6; $i <= 12; $i++ )
