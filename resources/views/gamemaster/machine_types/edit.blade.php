    ...
    <x-content-box>
        ...
        <form class="space-y-8" action="{{ route('machine_types.update', $machine_type->id) }}" method="POST">
            ...
            <div class="space-y-4">
                ...
                <input type="number" name="price" id="price" min="0" value="{{ $machine_type->price }}" step="5000000"
                    required
                    class="mt-1 block w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-gray-200 transition duration-300 ease-in-out transform hover:scale-105">
            </div>
            ...
            <div class="space-y-4">
                ...
                <input type="number" name="fix_costs_per_period" id="fix_costs_per_period" min="0"
                    value="{{ $machine_type->fix_costs_per_period }}" step="500000" required
                    class="mt-1 block w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-gray-200 transition duration-300 ease-in-out transform hover:scale-105">
            </div>
            ...
            <div class="space-y-4">
                ...
                <input type="number" name="capacity" id="capacity" min="0" value="{{ $machine_type->capacity }}"
                    step="5000" required
                    class="mt-1 block w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-gray-200 transition duration-300 ease-in-out transform hover:scale-105">
            </div>
            ...
            <div class="space-y-4">
                ...
                <input type="number" name="number_of_operators" id="number_of_operators" min="0"
                    value="{{ $machine_type->number_of_operators }}" step="5" required
                    class="mt-1 block w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-gray-200 transition duration-300 ease-in-out transform hover:scale-105">
            </div>
            ...
            <div class="space-y-4">
                ...
                <input type="number" name="depreciation_period" id="depreciation_period" min="0"
                    value="{{ $machine_type->depreciation_period }}" step="2" required
                    class="mt-1 block w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-gray-200 transition duration-300 ease-in-out transform hover:scale-105">
            </div>
