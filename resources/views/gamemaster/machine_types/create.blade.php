    ...
    <x-content-box>
        ...
        <form class="space-y-8" action="{{ route('machine_types.store') }}" method="POST">
            ...
            <div class="space-y-4">
                ...
                <input type="number" name="fix_costs_per_period" id="fix_costs_per_period" min="0" value="1000000"
                    step="500000" required
                    class="mt-1 block w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-gray-200 transition duration-300 ease-in-out transform hover:scale-105">
            </div>
            ...
            <div class="space-y-4">
                ...
                <input type="number" name="number_of_operators" id="number_of_operators" min="0" value="10" step="5"
                    required
                    class="mt-1 block w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-gray-200 transition duration-300 ease-in-out transform hover:scale-105">
            </div>
            ...
            <div class="space-y-4">
                ...
                <input type="number" name="depreciation_period" id="depreciation_period" min="0" value="8" step="2"
                    required
                    class="mt-1 block w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-gray-200 transition duration-300 ease-in-out transform hover:scale-105">
            </div>
